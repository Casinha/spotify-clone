...
var lyricsFinder = require("../node_modules/lyrics-finder/src/index.js");
...
app.get('/lyrics', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var track, artist, lyrics;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                track = req.query.track;
                artist = req.query.artist;
                return [4 /*yield*/, lyricsFinder(artist, track)];
            case 1:
                lyrics = (_a.sent()) || "No lyrics found";
